...
(function($) {
	...
	$(".bouton-connexion").click(function(){
	    $("body").addClass("is-overlay-connect");
	    var $conect=$(".form-connexion");
	    centrerElementFixed($conect);
	});

	$(".bouton-ins").click(function(){
	    $("body").addClass("is-overlay-ins");
	    var $conect=$(".form-ins");
	    centrerElementFixed($conect);
	});

	$(".close-connect").click(function(){
	    $("body").removeClass("is-overlay-connect");
	});

	$(".close-ins").click(function(){
	    $("body").removeClass("is-overlay-ins");
	});

	function centrerElementFixed(element){
        var largeur_fenetre = $(window).width();
        var hauteur_fenetre = $(window).height();
        var haut = (hauteur_fenetre - element.height()) / 2;
        var gauche = (largeur_fenetre - element.width()) / 2;
        element.css({position: 'absolute', top: 30, left: gauche});
    }
